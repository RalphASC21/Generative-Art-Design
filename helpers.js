...
//^^ALL FUNCTIONS ABOVE CALL THEIR SPECIFIC CONSTRUCTOR AND DISPLAY THE SHAPES TO FORM THE SNOWFLAKES
...
function myTriangle (center, radius, direction) {  //creates triangles at certain points
  if (direction) {
    beginShape();
...
const layerConstructors = [  //displays layers
  {
    name: 'Outline Shape',
